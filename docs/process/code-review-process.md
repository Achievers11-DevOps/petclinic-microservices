...
GPM-137: define team code review process

## Pull Request Workflow
1. Create feature branch from main
2. Do your work and commit with GPM-number in message
...
7. Assign at least 1 reviewer (etaoko333 or iamDayoDev)
8. Assign yourself as assignee
9. Wait for approval — do NOT merge your own PR
10. After dev merge Osenat raises PR from dev to main
...
| Branch up to date | Rebase before PR if behind main |
| Review comments | All must be resolved before merge |

## Reviewer Responsibilities
- Read every file changed in the PR
- Check commit messages reference correct Jira tickets
- Verify no existing files modified without reason
- Verify no secrets are hardcoded
- Verify CI is green before approving
- Leave clear comments if changes needed
...
.github/workflows/   only add new personal CI workflows
